...
(FamilyTree._defaultConfig = function (e) {
  ...
  (FamilyTree.editUI.prototype.content = function (e, t, i, r, a) {
    ...
    FamilyTree.isNEU(g) && (g = ""),
      (v = FamilyTree.isNEU(v)
        ...
        : `<img style="width: 100%;height:100%;border-radius: 50%;" src="${v}"></img>`);
    var w = !t,
      k = t ? "display:none;" : "",
      S = t || !s ? "display:none;" : "",
  ...
  (FamilyTree._exportIterateForJSON_XML_CSV = function (e, t, i, r) {
    if (Array.isArray(t))
      for (var a = 0; a < t.length; a++)
        FamilyTree._exportIterateForJSON_XML_CSV(e, t[a], i, r);
    else {
      var n = e.get(t.id);
      if ((r.push(n), i.min))
        for (a = 0; a < t.stChildrenIds.length; a++)
          FamilyTree._exportIterateForJSON_XML_CSV(
            e,
            e.getNode(t.stChildrenIds[a]),
            i,
            r
          );
      else
  ...
  (FamilyTree.prototype._pages = function (e, t, i, r) {
    ...
    ("Legal" == e.format && "fit" != e.scale)
      ...
      : ("A5" == e.format && "fit" == e.scale) ||
        ...
        ("Letter" == e.format && "fit" == e.scale) ||
        ("Legal" == e.format && "fit" == e.scale)
      ? r(this._pagesAfit(e, t, i))
      : "fit" == e.format && r(this._pagesFit(e, t));
  }),
  ...
  (FamilyTree.prototype._pagesAfit = function (e, t, i) {
    var r = t.getAttribute("width"),
      a = 0,
      n = 0;
    switch (e.format) {
      case "A5":
    ...
    var o = e.landscape
      ...
      l =
        ...
        o / r);
    return this._pagesA100(e, t, 100 * l, i);
  }),
  (FamilyTree.prototype._pagesA100 = function (e, t, i, r) {
    var a = FamilyTree._getViewBox(t),
      n = 0,
      o = 0;
    switch (e.format) {
      case "A5":
        (n = FamilyTree.A5w), (o = FamilyTree.A5h);
        break;
      case "A4":
        (n = FamilyTree.A4w), (o = FamilyTree.A4h);
        break;
      case "A3":
        (n = FamilyTree.A3w), (o = FamilyTree.A3h);
        break;
      case "A2":
        (n = FamilyTree.A2w), (o = FamilyTree.A2h);
        break;
      case "A1":
        (n = FamilyTree.A1w), (o = FamilyTree.A1h);
        break;
      case "Letter":
        (n = FamilyTree.Letterw), (o = FamilyTree.Letterh);
        break;
      case "Legal":
        (n = FamilyTree.Legalw), (o = FamilyTree.Legalh);
    }
    var l = a[0],
      s = a[1],
      d = a[2],
      ...
      m = {
        w: e.landscape
          ? o - (e.margin[1] + e.margin[3])
          : n - (e.margin[1] + e.margin[3]),
        h: e.landscape
          ? n - (e.margin[0] + e.margin[2])
          : o - (e.margin[0] + e.margin[2]),
      },
      h = { w: e.landscape ? o : n, h: e.landscape ? n : o };
    t.setAttribute("width", m.w), t.setAttribute("height", m.h);
    var p = m.w * (100 / i),
      f = m.h * (100 / i),
      u = l,
      y = s,
      g = [],
      v = !0;
    if (!FamilyTree.EXPORT_PAGES_CUT_NODES && "fit" == e.scale) {
      t.setAttribute("preserveAspectRatio", "xMinYMin");
      for (
        var T = Object.keys(r.bordersByRootIdAndLevel),
          b = r.bordersByRootIdAndLevel[T[0]],
          F = Object.keys(b).length,
          x = 1;
        x < T.length;
        x++
      )
        F < Object.keys(r.bordersByRootIdAndLevel[T[x]]).length &&
          ((b = r.bordersByRootIdAndLevel[T[x]]), (F = Object.keys(b).length));
      for (var _ = 0, w = 0; ; ) {
        for (w = _; !(F <= _); ) {
          if ((b[_].maxY - b[_].minY) / (100 / i) > m.h) {
            v = !1;
            break;
          }
          var k = (b[_].minY - b[w].minY) / (100 / i);
          if (
            (_ == F - 1 && (k = (b[_].maxY - b[w].minY) / (100 / i)), k > m.h)
          )
            break;
          _++;
        }
        if (!v) break;
        var S = (_ == F ? b[_ - 1].maxY : b[_ - 1].minY) - b[w].minY;
        if (0 == S) {
          v = !1;
          break;
        }
        if (
          ((C = (C = [u, b[w].minY, p, S]).join()),
          g.push({
            vb: C,
            innerSize: { w: m.x, h: S / (100 / i) - 1 },
            size: h,
          }),
          _ == F)
        )
      ...
      g.length && (g[g.length - 1].innerSize.h += 1);
    }
    if (!v || FamilyTree.EXPORT_PAGES_CUT_NODES || "fit" != e.scale)
      for (
        t.setAttribute("preserveAspectRatio", "xMinYMin slice"), g = [];
        u < d + l;
        ...
        for (; y < c + s; ) {
          var C;
          (C = (C = [u, y, p, f]).join()),
            g.push({ vb: C, innerSize: m, size: h }),
            (y += f);
        }
        (u += p), (y = s);
      }
    ...
    return {
      on: function (t, i, r) {
        Array.isArray(e[t]) || (e[t] = []),
          e[t].push({ listener: i, event_id: r });
      },
          ...
          for (var n = e[t].length - 1; n >= 0; n--)
            ((!FamilyTree.isNEU(r) &&
              ...
              (FamilyTree.isNEU(r) &&
                !FamilyTree.isNEU(i) &&
                e[t][n].listener == i) ||
              (FamilyTree.isNEU(r) && FamilyTree.isNEU(i))) &&
              (e[t].splice(n, 1), (a = !0));
        return a;
      },
      has: function (t, i) {
        ...
        (r.onload = function () {
          ...
          FamilyTree._importSetColumnNames(n, function (t) {
            ...
            0 != FamilyTree.events.publish("import", [e, d]) &&
              (e._putInUndoStack(),
              e.clearRedo(),
              (e.config.nodes = d.nodes),
              FamilyTree.events.publish("updated", [e]),
              e.filterUI.update(),
              e.draw());
          });
        }),
  ...
  (FamilyTree._importSetColumnNames = function (e, t) {
    if (-1 == e.indexOf("id") || -1 == e.indexOf("pid")) {
      ...
      for (var f = 0; f < e.length; f++) {
        ...
        T.appendChild(u), h.appendChild(T);
      }
      ...
      (v.id = "pid-select"),
        ...
        (v.style.margin = "5px"),
        (v.style.width = "60%"),
        (v.style.border = "1px solid #aeaeae"),
        i.appendChild(v);
  ...
  (FamilyTree.prototype.__importJSON = FamilyTree.prototype.importJSON),
  (FamilyTree.prototype.importJSON = function () {
    (this.config.roots = []), this.__importJSON();
  }),
  (FamilyTree.prototype.__importCSV = FamilyTree.prototype.importCSV),
  (FamilyTree.prototype.importCSV = function () {
    (this.config.roots = []), this.__importCSV();
  }),
  (FamilyTree.prototype.__importXML = FamilyTree.prototype.importXML),
  (FamilyTree.prototype.importXML = function () {
  ...
  (FamilyTree.prototype._resetMovableNodes = function () {
    if (
      FamilyTree.RESET_MOVABLE_ONEXPANDCOLLAPSE &&
      null != this.config.movable
    ) {
      for (var e = !1, t = 0; t < this.config.nodes.length; t++) {
        var i = this.config.nodes[t];
        null != i.movex && ((i.movex = 0), (e = !0)),
          null != i.movey && ((i.movey = 0), (e = !0));
      }
      e && FamilyTree.events.publish("updated", [this]);
    }
  }),
          ...
          if (p) {
            ...
            if (s.left || s.right || s.up || s.down) {
              ...
              if (null != c) {
                ...
                for (
                  var I = o.getNode(c),
                    N = FamilyTree.getStParentNodes(I),
                    A = 0;
                  A < N.length;
                  A++
                ) {
        ...
        F = function (t) {
          if (
            ...
            h.classList &&
              ...
              h.classList.remove("bft-cursor-nodrop"),
              h.classList.remove("bft-cursor-copy")),
            h.removeEventListener(i.move, b),
            ...
            return (
              ...
              void (
                ...
                FamilyTree.events.publish("drop", [
                  o.nodeCircleMenuUI,
                  { from: s.id, menuItemName: a, menuItem: n, event: t },
                ])
              )
            );
          var r = o.getNode(c);
          FamilyTree.events.publish("drop", [
            o.nodeCircleMenuUI,
            { from: s.id, to: r.id, menuItem: n, menuItemName: a, event: t },
          ]),
            T(c, m),
            h.removeChild(f),
            (o._gragStartedId = null);
        };
      h.addEventListener(i.move, b),
        h.addEventListener(i.up, F),
        i.leave && h.addEventListener(i.leave, F);
    }
  }),
  (FamilyTree.prototype._nodeMouseDownHandler = function (e, t, i) {
    var r = e.getAttribute(FamilyTree.attr.node_id),
      a = this.getNode(r);
    this.config.movable && !FamilyTree.getRootOf(a).stParent
      ? this._movableHandler(e, t, i)
      : this.config.enableDragDrop && this._dragDropHandler(e, t, i);
  }),
  (FamilyTree.prototype._movableHandler = function (e, t, i) {
    var r = this,
      a = e.getAttribute(FamilyTree.attr.node_id),
      n = [],
      o = function (e, t) {
        if (Array.isArray(e)) for (var i = 0; i < e.length; i++) o(e[i], t);
        else {
          t.push(e.id);
          for (i = 0; i < e.stChildren.length; i++) o(e.stChildren[i], t);
          for (i = 0; i < e.children.length; i++) o(e.children[i], t);
        }
      },
      l = function (e, t) {
        if (Array.isArray(e)) for (var i = 0; i < e.length; i++) o(e[i], t);
          ...
          t.push(e.id);
          for (i = 0; i < e.stChildrenIds.length; i++)
            l(r.getNode(e.stChildrenIds[i]), t);
          for (i = 0; i < e.childrenIds.length; i++)
            l(r.getNode(e.childrenIds[i]), t);
        }
      },
      s = this.getNode(a);
    o(s, n);
    for (
      ...
      var b = this.getNode(n[T]);
      m.push(b), p.push({ x: b.x, y: b.y });
      var F = this.getNodeElement(n[T]);
      if (F) {
        u.push(F);
        var x = FamilyTree._getTransform(F);
        f.push({ x: x[4], y: x[5] }), h.push(x);
        var _ = this.element.querySelector(`[data-ctrl-ec-id="${n[T]}"]`);
        if (_) {
          y.push(_);
          var w = FamilyTree._getTransform(_);
          g.push(w), v.push({ x: w[4], y: w[5] });
        } else y.push(null), g.push(null), v.push(null);
        if (this.config.movable == FamilyTree.movable.node) break;
      }
    }
    e._dragEventFired = !1;
    var k = null,
    ...
    var C = { x: c.x, y: c.y },
      ...
      N = function (e, t) {
        if (null != e) {
          t.classList.remove("bft-drag-over");
          for (
            var i = r.getNode(k), a = FamilyTree.getStParentNodes(i), n = 0;
            n < a.length;
            n++
          ) {
      ...
      A = function (t) {
        if (C) {
          var i = FamilyTree._getClientXY(t),
            o = t.target;
          FamilyTree.isMobile() && (o = document.elementFromPoint(i.x, i.y));
          ...
          if (c.left || c.right || c.up || c.down) {
            ...
            for (var T = [], b = [], F = [], x = [], _ = 0; _ < h.length; _++)
              T.push(h[_][4]),
                b.push(h[_][5]),
                g[_]
                  ? (F.push(g[_][4]), x.push(g[_][5]))
                  : (F.push(null), x.push(null));
            var w = C.x,
              A = C.y,
              E = i.x,
              M = i.y;
            r.moveStart(c, function (e) {
              for (var t = 0; t < h.length; t++) {
                ...
                (h[t][4] = a + e.x),
                  (h[t][5] = n + e.y),
                  (C.x = w - e.xWithoutScale),
                  (C.y = A - e.yWithoutScale),
                  (i.x = E - e.xWithoutScale),
                  (i.y = M - e.yWithoutScale),
                  (m[t].x = a + e.x),
                  (m[t].y = n + e.y),
                  (m[t].movex = e.x),
                  (m[t].movey = e.y),
                  g[t] && ((g[t][4] = o + e.x), (g[t][5] = l + e.y));
                for (
                  var s = FamilyTree.ui.link(
                      m[t],
                      r,
                      I,
                      r.response.bordersByRootIdAndLevel,
                      r.nodes,
                  ...
                  (p = r.element.querySelector(
                    `[data-l-id="[${c.id}][${c.childId}]"]`
                  )) && (p.innerHTML = c.html);
                }
                if (m[t].parent)
                  for (
                    s = FamilyTree.ui.link(
                      m[t].parent,
                      r,
                      I,
                      r.response.bordersByRootIdAndLevel,
            ...
            if (
              ...
              (k = null),
              (S = null),
              r.config.enableDragDrop)
            )
              for (; null != o && o != d; ) {
                if (o.hasAttribute && o.hasAttribute(FamilyTree.attr.node_id)) {
                  var O = o.getAttribute(FamilyTree.attr.node_id);
                  if (r._gragStartedId && O != r._gragStartedId) {
                    (k = O), (S = o);
                    break;
                  }
                }
            ...
            if (null != k) {
              S.classList.add("bft-drag-over");
              for (
                var U = r.getNode(k), B = FamilyTree.getStParentNodes(U), R = 0;
                R < B.length;
                R++
              ) {
                var P = r.getNodeElement(B[R].id);
                P && (P.style.opacity = 0.1);
              }
              !r.canUpdateLink(m[0].id, k) && d.classList
                ? (d.classList.remove("bft-cursor-grab"),
                  d.classList.remove("bft-cursor-move"),
                  d.classList.remove("bft-cursor-copy"),
            ...
            for (_ = 0; _ < h.length; _++) {
              (h[_][4] = f[_].x + D),
                (h[_][5] = f[_].y + H),
                g[_] && ((g[_][4] = v[_].x + D), (g[_][5] = v[_].y + H)),
                (m[_].x = p[_].x + D),
                (m[_].y = p[_].y + H),
                (m[_].movex = D),
                (m[_].movey = H);
              var z = FamilyTree.ui.link(
                m[_],
                r,
                I,
                r.response.bordersByRootIdAndLevel,
              ...
              for (R = 0; R < z.length; R++) {
                var $ = z[R];
                (j = r.element.querySelector(
                  `[data-l-id="[${$.id}][${$.childId}]"]`
                )) && (j.innerHTML = $.html);
              }
            }
            if (s.parent)
              if (r.config.movable == FamilyTree.movable.detachTree)
                (j = r.element.querySelector(
                  `[data-l-id="[${s.parent.id}][${s.id}]"]`
                )) && j.parentElement.removeChild(j);
              else
                for (
                  z = FamilyTree.ui.link(
                    s.parent,
                    r,
                    I,
                    r.response.bordersByRootIdAndLevel,
            ...
            if (
              ...
              if (
                (!1 === FamilyTree.events.publish("drag", [r, a, t, n]) && L(),
                r.config.enableDragDrop)
              )
                for (_ = 0; _ < u.length; _++)
                  d.insertBefore(u[_], d.firstChild);
              e._dragEventFired = !0;
            }
            for (_ = 0; _ < h.length; _++)
              u[_].setAttribute("transform", "matrix(" + h[_].toString() + ")"),
                y[_] &&
                  y[_].setAttribute(
                    "transform",
                    "matrix(" + g[_].toString() + ")"
      ...
      L = function (t) {
        for (var a = 0; a < m.length; a++) (m[a].x = p[a].x), (m[a].y = p[a].y);
        if (
          (r.moveEnd(),
          d.classList &&
            (d.classList.remove("bft-cursor-grab"),
            ...
            d.classList.remove("bft-cursor-nodrop"),
            d.classList.remove("bft-cursor-copy")),
          d.removeEventListener(i.move, A),
          d.removeEventListener(i.up, L),
          i.leave && d.removeEventListener(i.leave, L),
          m[0].id != k && null != k)
        ) {
          var n = r.getNode(k);
          if (
            !1 ===
            (o = FamilyTree.events.publish("drop", [r, m[0].id, n.id, u[0], t]))
          )
            return N(k, S), void (r._gragStartedId = null);
          if (r.canUpdateLink(m[0].id, k))
            ((g = r.get(m[0].id)).pid = k),
              (g.stpid = null),
          ...
          if (e._dragEventFired) {
            var o = FamilyTree.events.publish("drop", [
              r,
              m[0].id,
              void 0,
              u[0],
            ...
            if (r.config.movable && !1 !== o)
              if (r.config.movable == FamilyTree.movable.detachTree) {
                var c = FamilyTree._getTransform(r.getNodeElement(s.id));
                ((g = r.get(s.id)).pid = null),
                  (g.stpid = null),
                  r.updateNode(g, null, !0);
              } else {
                var h = [];
                ...
                for (a = 0; a < h.length; a++) {
                  var g;
                  (g = r.get(h[a])) &&
                    (null != g.movex ? (g.movex += f) : (g.movex = f),
                    null != g.movey ? (g.movey += y) : (g.movey = y),
                    r.update(g));
                }
                FamilyTree.events.publish("updated", [r]),
                  r.draw(FamilyTree.action.update, { dragNodeIdList: h });
              }
          }
          r._gragStartedId = null;
        }
      };
    d.addEventListener(i.move, A),
      d.addEventListener(i.up, L),
      i.leave && d.addEventListener(i.leave, L);
  }),
  (FamilyTree.prototype._dragDropHandler = function (e, t, i) {
    ...
    var y = function (e, t) {
        ...
        if (c) {
          ...
          if (g.left || g.right || g.up || g.down) {
            ...
            if (("draging" == o && ((o = null), (l = null)), null != o)) {
              ...
              for (
                var S = s.getNode(o), C = FamilyTree.getStParentNodes(S), I = 0;
                I < C.length;
                I++
              ) {
              ...
              !s.canUpdateLink(n.id, o) && d.classList
                ? (d.classList.remove("bft-cursor-grab"),
                  d.classList.remove("bft-cursor-move"),
                  d.classList.remove("bft-cursor-copy"),
                  d.classList.add("bft-cursor-nodrop"))
            ...
            if (
              ...
              !1 === FamilyTree.events.publish("drag", [s, k, t]) && v(),
                (e._dragEventFired = !0);
            u.setAttribute("transform", "matrix(" + m.toString() + ")");
          }
        }
      ...
      v = function (t) {
        if (
          ...
          d.removeEventListener(i.up, v),
          i.leave && d.removeEventListener(i.leave, v),
          n.id == o || null == o)
        )
          return (
            e._dragEventFired &&
              FamilyTree.events.publish("drop", [s, n.id, void 0, u, t]),
            d.removeChild(u),
            void (s._gragStartedId = null)
          );
        var r = s.getNode(o);
        if (!1 === FamilyTree.events.publish("drop", [s, n.id, r.id, u, t]))
          return y(o, l), d.removeChild(u), void (s._gragStartedId = null);
    ...
    d.addEventListener(i.move, g),
      d.addEventListener(i.up, v),
      i.leave && d.addEventListener(i.leave, v);
  }),
      ...
      if (!this._moveInterval) {
        ...
        FamilyTree.isNEU(i) && (i = FamilyTree.anim.inSin),
          ...
          (this._moveInterval = setInterval(function () {
            ...
            e.left
              ? (l++,
                (c.x = (l * FamilyTree.MOVE_STEP) / o),
                (c.xWithoutScale = l * FamilyTree.MOVE_STEP))
              : e.right &&
                (l++,
                (c.x = (-l * FamilyTree.MOVE_STEP) / o),
                (c.xWithoutScale = -l * FamilyTree.MOVE_STEP)),
  ...
  (FamilyTree.prototype._mouseDownHandler = function (e, t, i) {
    ...
    t.touches &&
      ...
      "pan" == s.type &&
        (this._hideBeforeAnimation(), this._changeCursorOnPanStart(a, n, t));
    var d = function (e) {
  ...
  (FamilyTree.prototype._changeCursorOnPanStart = function (e, t, i) {
    ...
    (r.style.display = "inherit"),
      r.setAttribute("transform", "matrix(0,0,0,0," + n + "," + o + ")"),
      FamilyTree.animate(
        r,
        { transform: [0, 0, 0, 0, n, o], opacity: 0 },
        { transform: [1 / t, 0, 0, 1 / t, n, o], opacity: 1 },
        300,
        FamilyTree.anim.outBack
      );
  }),
  ...
  (FamilyTree.searchUI.prototype.init = function (e) {
    ...
    l.classList.add("bft-search"),
      (l.style.right = i + "px"),
      (l.style.top = r + "px");
    var s = FamilyTree.elements.textbox(
      {},
      { label: FamilyTree.SEARCH_PLACEHOLDER, btn: "X" },
      "320px"
    );
    (l.innerHTML += s.html),
    ...
    this.instance.element.insertBefore(l, d),
      FamilyTree.input.init(l),
  ...
  (FamilyTree.searchUI.prototype._initSearchFields = function () {
    ...
    if (null == this.instance.config.searchFieldsAbbreviation) {
      ...
      for (e = 0; e < this._searchFields.length; e++) {
        for (
          var i = this._searchFields[e],
            r = 0,
            a = i.slice(0, r + 1).toLowerCase();
  ...
  (FamilyTree.searchUI.prototype.addMatchTag = function (e) {
    if (this._searchAfterEnterPress) {
      for (var t = 0; t < this.lastSearch.length; t++)
        if (this.lastSearch[t].id == e) return !0;
      return !1;
    }
    return null;
  }),
  ...
  (FamilyTree.searchUI.prototype._search = function () {
    ...
    if (
      ((this._searchAfterEnterPress = !1),
      this.input.value == FamilyTree.SEARCH_HELP_SYMBOL)
    )
      e = this.helpView();
    else {
      this.__search();
      ...
      e = `<table border="0" cellspacing="0" cellpadding="0">\n                        <tbody>\n                            ${(function () {
        for (
          var e = "", r = 0;
          r < t.lastSearch.length && !(r >= FamilyTree.SEARCH_RESULT_LIMIT);
          r++
        ) {
          ...
          if (i) {
            ...
            "function" == typeof i
              ? (n = i(t.instance, t.instance.getNode(a.id), o))
              : o[i] && (n = o[i]);
          }
          var l = "",
            s = "";
          t.instance.config.searchDisplayField == a.__searchField
            ? (l = a.__searchMarks)
            : t.instance.config.searchDisplayField
            ? ((l = a[t.instance.config.searchDisplayField]),
              FamilyTree.isNEU(l) && (l = ""),
              (s = a.__searchMarks))
            : (l = a.__searchMarks);
          var d = {
            img: n,
    ...
    for (
      var r = this.instance.element.querySelectorAll("[data-search-item-id]"),
        a = 0;
      a < r.length;
      a++
    )
      r[a].addEventListener("click", function () {
        if (this.hasAttribute("data-search-item-id")) {
          ...
          if (t.input.value != FamilyTree.SEARCH_HELP_SYMBOL) {
            ...
            (t.input.value = e + " "),
              (t.searchTableWrapper.innerHTML = ""),
              t.input.focus();
        }
      });
  ...
  (FamilyTree.searchUI.prototype.helpView = function () {
    ...
    for (var t in this.searchFieldsAbbreviation)
      e += `<tr data-search-item-id="${t}" style="height: 50px;"><td class="bft-search-image-td" style="text-align: center;">${t}</td><td class="bft-search-text-td">${this.searchFieldsAbbreviation[t]}</td></tr>`;
    return (e += "</table>");
  }),
    ...
    this._searchAfterEnterPress &&
      ...
      this.input &&
        ...
        document.activeElement == this.xBtn &&
          FamilyTree.input.blurHandler(this.input));
  }),
      ...
      o._setPositions(
        ...
        function (t) {
          ...
          i.state &&
            ...
            (o = i.state.adjustify),
            i.action == FamilyTree.action.exporting
              ? (o = i._fixAdjustForExport)
              : (i._fixAdjustForExport = o);
          for (
  ...
  (FamilyTree.manager._initDinamicNode = function (e, t, i) {
    ...
    (e.w = r && r.size ? r.size[0] : 0),
      ...
      (e.isMirror = "mirror" == e.templateName),
      (e.isSubLevel = "subLevel" == e.templateName);
  }),
  (FamilyTree.manager._setCollpasedProperty = function (e, t, i, r, a, n, o) {
    null == e.collapsed && t.collapse && t.collapse.allChildren
      ...
      a == FamilyTree.action.init && null != o
        ...
        : a == FamilyTree.action.update &&
          i &&
          i.changeRoots &&
          i.changeRoots.has(e.id) &&
          (e.collapsed = !1);
  }),
  (FamilyTree.manager._initNode = function (e, t, i, r, a, n, o) {
    var l = o.manager.config,
      ...
      h = s[i || "base"];
    null == e.parent &&
      FamilyTree.manager._setCollpasedProperty(e, h, c, a, d, r - 1, m);
    for (var p = 0; p < e.childrenIds.length; p++) {
      var f = t[e.childrenIds[p]];
      if (
        (FamilyTree.manager._setCollpasedProperty(f, h, c, a, d, r, m),
        !f.collapsed)
      ) {
    ...
    if (
      (d != FamilyTree.action.minimize || e.min
        ? d == FamilyTree.action.maximize && !0 === e.min
          ...
          ? (e.min = !1)
          : d == FamilyTree.action.init &&
            null != m &&
            (e.min = m.min.has(e.id))
        : (c.all || c.id == e.id) && (e.min = !0),
      !e.min)
    )
      for (p = 0; p < e.stChildrenIds.length; p++) {
        f = t[e.stChildrenIds[p]];
        (e.tags && e.tags.has("filter")) ||
          ((f.stParent = e), e.stChildren.push(f));
      }
    ...
    if (
      ...
      if (
        ...
        ((FamilyTree.MIXED_LAYOUT_ALL_NODES &&
          p.length > 1 &&
          p.length == t.parent.children.length - f - u) ||
          (!FamilyTree.MIXED_LAYOUT_ALL_NODES && p.length > 1)) &&
          (l[t.pid] = p);
      }
    } else if (
      !t.isAssistant &&
      ...
      for (p = [], f = 0, u = 0, y = 0; y < t.parent.children.length; y++) {
        var g;
        -1 == (g = t.parent.children[y]).tags.indexOf("partner") &&
        -1 == g.tags.indexOf("left-partner") &&
        -1 == g.tags.indexOf("right-partner") &&
      ...
      ((FamilyTree.MIXED_LAYOUT_ALL_NODES &&
        p.length > FamilyTree.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN &&
        p.length == t.parent.childrenIds.length - f - u) ||
        (!FamilyTree.MIXED_LAYOUT_ALL_NODES &&
          p.length >
            FamilyTree.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN)) &&
        (l[t.pid] = p);
    }
    t.stChildren.length &&
  ...
  (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, o, l) {
    for (
      var s = [], d = FamilyTree._addDottedLines(i), c = 0;
      c < d.length;
      c++
    ) {
      var m,
      ...
      (m = FamilyTree.STRING_TAGS
        ...
        ? h.tags.slice(0)
        : []),
        l.filterUI.addFilterTag(h) && m.unshift("filter");
      var p = l.searchUI.addMatchTag(h.id);
      !0 === p ? m.unshift("match") : !1 === p && m.unshift("no-match");
      var f = FamilyTree._getTemplate(m, i.tags, i.template),
        u = new FamilyTree.node(h.id, h.pid, m, f);
      FamilyTree.isNEU(h.ppid) || (u.ppid = h.ppid),
        FamilyTree.isNEU(h.stpid) || (u.stpid = h.stpid),
        null != i.orderBy &&
          (u.order = FamilyTree.manager._getOrderFieldValue(h, i.orderBy)),
        null != h.movex && (u.movex = h.movex),
        null != h.movey && (u.movey = h.movey),
        (e[h.id] = u),
        s.push(h.id);
    }
    null != i.orderBy &&
    ...
    for (c = 0; c < s.length; c++) {
      ...
      if ((v || (u.stpid = null), T || (u.pid = null), v)) {
        ...
        T
          ? (g && ((u.collapsed = g.collapsed), (u.min = g.min)),
            T.childrenIds.push(u.id))
          : (g && ((u.collapsed = g.collapsed), (u.min = g.min)),
            t.push(u),
            o.push(u.id));
  ...
  (FamilyTree.manager._createNodes = function (e) {
    var t = e.manager.config,
      ...
      d = [];
    if (
      (FamilyTree.manager.__createNodes(l, s, t, r, a, n, d, e),
      null != t.roots)
    ) {
      s = [];
      for (var c = 0; c < t.roots.length; c++) {
        ...
        if (m && r == FamilyTree.action.centerNode) {
          for (var h = m; null != h.pid || null != h.stpid; )
            h = null == h.pid && null != h.stpid ? l[h.stpid] : l[h.pid];
          for (var p = l[a.id]; (null != p.pid || null != p.stpid) && p != m; )
        ...
        if (m) {
          ...
          if (!f) {
            if (!FamilyTree.isNEU(m.pid))
              (ue = (v = l[m.pid]).childrenIds.indexOf(m.id)) > -1 &&
                v.childrenIds.splice(ue, 1);
            s.push(m);
          }
        }
      }
    ...
    r == FamilyTree.action.exporting &&
      null != a.id &&
      (g = l[a.id]) &&
      ((g.pid = null), (s = [g]));
    var y = [];
    if (r == FamilyTree.action.init && t.expand && t.expand.nodes && null == o)
      for (c = 0; c < t.expand.nodes.length; c++) {
        var g = l[t.expand.nodes[c]];
        for (
          !0 === t.expand.allChildren &&
          FamilyTree.manager._addExpandedNodeIdsIterate(g, l, y);
          g;

        )
          y.push(g.id),
            null == g.pid && null != g.stpid
              ? ((g = l[g.stpid]).min = !1)
              : (g = l[g.pid]);
      }
    else if (
      ...
      for (c = 0; c < re.length; c++)
        for (var v = l[(g = l[re[c]]).pid]; v; )
          y.push(v.id),
            null == v.pid && null != v.stpid
              ? ((v = l[v.stpid]).min = !1)
              : (v = l[v.pid]);
      ...
      for (var T = l[a.id]; T; ) {
        if (
          (y.push(T.id),
          a.options.parentState === FamilyTree.COLLAPSE_PARENT_NEIGHBORS && T)
        )
          for (c = 0; c < T.childrenIds.length; c++) {
    ...
    var x = [],
      ...
      S = [];
    for (c = 0; c < s.length; c++)
      FamilyTree.manager._iterate(s[c], s[c], l, 0, x, _, w, k, "", y, S, e);
    if (
      r == FamilyTree.action.collapse &&
      a &&
      ...
      for (c = 0; c < a.ids.length; c++) {
        if (a.expandIds.has(a.collapseIds[c]))
          console.error(
            `id ${a.collapseIds[c]} exist in both collapseIds and expandIds`
          );
        else (g = l[a.collapseIds[c]]) && (g.collapsed = !0);
      }
    ...
    for (c = 0; c < S.length; c++) {
      ...
      for (b = 0; b < g.children.length; b++) {
        (D = g.children[b]).isAssistant
          ? C.push(D.id)
          : -1 != D.tags.indexOf("right-partner")
          ? ((D.isPartner = 1), (D.children = []), I.push(D.id))
          : -1 != D.tags.indexOf("left-partner")
          ? ((D.isPartner = 2), (D.children = []), N.push(D.id))
          : -1 == D.tags.indexOf("partner") || L % 2
          ? -1 != D.tags.indexOf("partner") && L % 2
            ? ((D.isPartner = 2), (D.children = []), N.push(D.id), L++)
            : D.parentPartner
            ? (A[D.parentPartner.id] || (A[D.parentPartner.id] = []),
              A[D.parentPartner.id].push(D.id))
            : C.push(D.id)
          : ((D.isPartner = 1), (D.children = []), I.push(D.id), L++);
      }
      g.children = [];
      var B = [];
      ...
      for (b = 0; b < P.length; b++) {
        (D = l[P[b]]).collapsed ||
          ((D.parentPartner = D.parent),
          (D.parent = g),
          (D.isChildOfPartner = !0),
          g.children.push(D));
      }
      for (b = N.length - 1; b >= 0; b--)
        if (A[N[b]])
          for (u = 0; u < A[N[b]].length; u++)
            g.children.push(l[A[N[b]][u]]),
              E++,
              -1 == U.indexOf(N[b]) && U.push(N[b]);
      ...
      for (b = 0; b < I.length; b++)
        if (A[I[b]])
          for (u = 0; u < A[I[b]].length; u++)
            g.children.push(l[A[I[b]][u]]),
              M++,
              -1 == O.indexOf(I[b]) && O.push(I[b]);
      ...
      (g.partnerSeparation =
        Math.max(U.length, O.length) * t.partnerChildrenSplitSeparation +
        t.minPartnerSeparation),
        C.length || !E || M
          ? C.length || E || !M
            ? C.length || 1 != E || 1 != M
              ? C.length || E || M
    ...
    for (c = 0; c < w.length; c++) {
      ...
      for (b = 0; b < g.subLevels; b++) {
        var z = new FamilyTree.node(
          g.id + "_sub_level_index_" + b,
          g.pid,
          [],
          "subLevel"
        );
        if ((FamilyTree.manager._initDinamicNode(z, g.lcn), (v = g.parent)))
          (ue = v.children.indexOf(g)) > -1 &&
            (v.children.splice(ue, 1), v.children.splice(ue, 0, z)),
            z.children.push(g),
            (z.parent = v),
            (g.parent = z),
            (l[z.id] = z);
    ...
    for (var $ in _) {
      ...
      for (b = v.children.length - 1; b >= 0; b--) {
        (D = v.children[b]).isAssistant
          ? ((D.parent = null), v.children.splice(b, 1), j.splice(0, 0, D.id))
          : D.isPartner ||
            (D.parent &&
              k[D.parent.id] &&
              z &&
              ...
              (Object.defineProperty(
                k,
                z.id,
                Object.getOwnPropertyDescriptor(k, D.parent.id)
              ),
              delete k[D.parent.id]),
            (D.parent = z),
            z.children.unshift(D),
            v.children.splice(b, 1));
      }
      if (j.length % 2) {
        var Y = l[j[j.length - 1]],
          X = new FamilyTree.node(Y.id + "_mirror", v.pid, [], "mirror");
        FamilyTree.manager._initDinamicNode(X, Y.lcn, !0),
          (X.isAssistant = !0),
          (X.w = Y.w),
          (X.h = Y.h),
          (l[X.id] = X),
          j.splice(j.length - 1, 0, X.id);
      }
      var q = 1;
      for (b = j.length - 1; b >= 0; b--)
        if (b % 2 && b != j.length - 1) {
          var V = new FamilyTree.node(
            v.id + "_split_assitant_" + q,
            v.pid,
            [],
            "split"
          );
          FamilyTree.manager._initDinamicNode(V, v.lcn, !0),
            (l[V.id] = V),
            j.splice(b, 0, V.id),
            q++;
    ...
    if (Z || ee) {
          ...
          for (var $ in k) {
            ...
            for (c = 0; c < re.length; c++) {
              ...
              (null === se || w.has(de)) &&
                ((se = l[de].parent.id),
                le ||
                  FamilyTree.isNEU(l[de].subLevels) ||
                  (le = l[de].subLevels > 0)),
                ae[se] || (ae[se] = []),
                ae[se].push(de),
                le && ((oe[se] = $), ne[se] || (ne[se] = []), ne[se].push(de));
            }
          }
          for (var $ in ((k = {}), ne))
            if (
      ...
      for (var $ in k) {
        ...
        if (0 != (H = i[v.lcn ? v.lcn : "base"]).layout || ee) {
          (te.pnode = v),
            (te.layout = H.layout),
            (te.layoutGridColumns = t.layoutGridColumns),
            (te.childrenIds = k[$]),
            (te.lastChildrenPidIds = k),
            (te.subLevels = 0),
            (te.layouts = []),
            FamilyTree.events.publish("node-layout", [e, te]),
            FamilyTree.events.publish("layout", [te]),
            te.layouts.length ||
              te.layouts.push({
                layout: te.layout,
                childrenIds: te.childrenIds,
                subLevels: te.subLevels,
                layoutGridColumns: te.layoutGridColumns,
              });
          for (var he = 0; he < te.layouts.length; he++) {
            var pe = te.layouts[he];
            for (
              FamilyTree.isNEU(pe.subLevels) && (pe.subLevels = 0),
                FamilyTree.isNEU(pe.layout) && (pe.layout = H.layout),
                me = v = l[$];
              me.isSplit;
            ...
            for (; me.isSubLevel; ) me = l[me.pid];
            var fe = v;
            for (b = 0; b < pe.subLevels; b++) {
              z = new FamilyTree.node(
                he + "_sublevel_layout_" + b,
                fe.id,
                [],
                "subLevel"
              );
              FamilyTree.manager._initDinamicNode(z, fe.lcn),
                (z.parent = fe),
                fe.children.push(z),
                (l[z.id] = z),
                (fe = z);
            ...
            if (pe.subLevels) {
              for (b = 0; b < pe.childrenIds.length; b++) {
                var ue;
                D = l[pe.childrenIds[b]];
                -1 != (ue = v.children.indexOf(D)) && v.children.splice(ue, 1),
                  (D.parent = fe),
                  fe.children.push(D);
              }
              v = fe;
            ...
            if (
              pe.layout == FamilyTree.layout.grid &&
              pe.childrenIds.length > 2
            ) {
              "dynamic" == pe.layoutGridColumns &&
                (pe.layoutGridColumns = FamilyTree._getDynamicGridCoulumns(
                  pe.childrenIds.length
                ));
              var ye = v.id;
              for (c = v.children.length - 1; c >= 0; c--)
                for (b = 0; b < pe.childrenIds.length; b++) {
                  de = pe.childrenIds[b];
                  if (v.children[c].id == de) {
                    v.children.splice(c, 1);
                    break;
                  }
                }
              var ge = pe.layoutGridColumns;
              ge % 2 != 0 && ge > 2 && ge--;
              for (c = 0; c < pe.childrenIds.length; c += ge) {
                var ve = null;
                for (b = 0; b < ge; b++) {
                  var Te = c + ge >= pe.childrenIds.length;
                  if (pe.childrenIds.length - 1 < c + b) break;
                  ((D = l[(de = pe.childrenIds[c + b])]).parent = l[ye]),
                    l[ye].children.push(D),
                    Te ||
                      (ge / 2 - 1 == b &&
                        ((ve = new FamilyTree.node(
                          pe.childrenIds[c + b - 1] +
                            "_grid_pseudo_node_" +
                            pe.childrenIds[c + b + 1],
                          ye,
                          [],
                        ...
                        FamilyTree.manager._initDinamicNode(ve, v.lcn),
                        (ve.parent = l[ye]),
                        l[ye].children.push(ve),
                        (l[ve.id] = ve)),
                      ge - 1 == b && (ye = ve.id));
                }
              }
            }
            if (pe.layout == FamilyTree.layout.mixed) {
              var be = pe.childrenIds;
              for (c = be.length - 1; c >= 0; c--) {
                (v = (D = l[be[c]]).parent),
                  (D.layout = FamilyTree.layout.mixed);
                for (b = v.children.length - 1; b >= 0; b--)
                  if (D.id == v.children[b].id) {
                    v.children.splice(b, 1);
                    break;
                  }
                if (c > 0) {
              ...
              FamilyTree.manager._initDinamicNode(z, v.lcn),
                (l[z.id] = z),
                (z.layout = pe.layout);
              var xe = [];
              for (c = pe.childrenIds.length - 1; c >= 0; c--) {
                for (
                  D = l[pe.childrenIds[c]], b = 0;
                  b < v.children.length;
                  b++
                )
                  v.children[b].id == D.id && v.children.splice(b, 1);
                if (
                  ((D.parent = null),
                  (D.layout = pe.layout),
                  (pe.layout != FamilyTree.layout.treeRightOffset &&
                    pe.layout != FamilyTree.layout.treeRight) ||
                    xe.splice(0, 0, D.id),
                  pe.layout > 2)
                ) {
                  var _e = new FamilyTree.node(
                    he + "_" + D.id + "_mirror",
                    me.id,
                    [],
                    "mirror"
                  );
                  FamilyTree.manager._initDinamicNode(_e, D.lcn),
                    (_e.layout = pe.layout),
                    (l[_e.id] = _e),
                    xe.splice(0, 0, _e.id);
                }
              ...
              for (q = 1, b = xe.length - 1; b >= 0; b--)
                if (b % 2 && b != xe.length - 1) {
                  V = new FamilyTree.node(
                    he + "_" + v.id + "_split_" + q,
                    me.id,
                    [],
                    "split"
                  );
                  FamilyTree.manager._initDinamicNode(V, v.lcn),
                    (V.layout = pe.layout),
                    (l[V.id] = V),
                    xe.splice(b, 0, V.id),
                    q++;
                } else b % 2 && xe.splice(b, 0, z.id);
              for (b = 0; b < xe.length; b += 3) {
                G = null;
                0 == b && (G = v);
                (W = l[xe[b]]), (J = l[xe[b + 1]]), (K = l[xe[b + 2]]);
                0 != b && (G = l[xe[b - 3]]),
                  0 == b || J || (G = l[xe[b - 2]]),
                  (W.parent = G),
                  G.children.push(W),
    ...
    if (FamilyTree.VERTICAL_CHILDREN_ASSISTANT)
      for (c = 0; c < s.length; c++)
        FamilyTree.manager._verticalAssistantIterate(s[c], l);
    te = { nodes: l, roots: s };
    return (
      FamilyTree.events.publish("nodes-initialized", [e, te]),
      { nodes: te.nodes, roots: te.roots, rootList: d }
    );
  }),
  ...
  (FamilyTree.manager._getResponse = function (
    ...
    if (
      ...
      if (x - 2 * r.padding >= a - o)
        ...
        switch (
          ((w = u.x - x / 2 + FamilyTree.manager._getNodeWidth(u, r) / 2),
          r.orientation)
        ) {
          case FamilyTree.orientation.right:
          case FamilyTree.orientation.right_top:
    ...
    if (
      ...
      if (
        ...
        (c != FamilyTree.action.expand && c != FamilyTree.action.collapse) ||
        !m ||
        null == m.id ||
        null == m.id
      ) {
    ...
    for (var N = 0; N < d.length; N++)
      FamilyTree.manager._iterate2(d[N], h, r, s, c, m, y, p, i, v);
    return {
      animations: v,
      boundary: g,
      viewBox: s,
    ...
    if (FamilyTree.manager._isVisible(e, i, r, a)) {
      ...
      if (
        ...
        if (((c = { x: (f = l[e.id]).x, y: f.y }), f)) {
          ...
          h && h.parent && (c = { x: h.parent.x, y: h.parent.y });
        }
        if ((u = t[n.id])) {
        ...
        if (
          (null != (f = l[e.id]).x && null != f.y && (c = { x: f.x, y: f.y }),
          (p = t[n.id]) && p == e)
        )
          (m = e.parent) &&
            m.id == n.id &&
            (c = { x: p.x + p.w / 2 - e.w / 2, y: p.y + p.h / 2 - e.h / 2 });
      ...
      if (null != c && null != c.x && null != c.y)
        if (c.x != e.x || c.y != e.y)
          (n && n.dragNodeIdList && -1 != n.dragNodeIdList.indexOf(e.id)) ||
            (d[0].push(e.id),
            d[1].push({ transform: [1, 0, 0, 1, c.x, c.y] }),
            d[2].push({ transform: [1, 0, 0, 1, e.x, e.y] }));
    }
    for (var y = 0; y < e.stChildren.length; y++)
      FamilyTree.manager._iterate2(e.stChildren[y], t, i, r, a, n, o, l, s, d);
    for (y = 0; y < e.children.length; y++)
      FamilyTree.manager._iterate2(e.children[y], t, i, r, a, n, o, l, s, d);
  }),
  ...
  (FamilyTree.manager._verticalAssistantIterate = function (e, t) {
    for (var i = 0; i < e.stChildren.length; i++)
      FamilyTree.manager._verticalAssistantIterate(e.stChildren[i], t);
    if (3 == e.children.length)
      ...
      for (i = 0; i < e.children.length; i++)
        FamilyTree.manager._verticalAssistantIterate(e.children[i], t);
    if (e.isAssistant && e.isSplit && e.children.length) {
      for (
        var r = e.parent.children[0], a = e.parent.children[2], n = e.parent;
        !n.hasAssistants;
      ...
      var o = { max: 0 },
        l = { max: 0 };
      FamilyTree.manager._verticalAssistantLevelCountIterate(r, 0, o),
        FamilyTree.manager._verticalAssistantLevelCountIterate(a, 0, l);
      var s = Math.max(o.max, l.max),
        d = [];
      for (i = 0; i < s; i++) {
        var c = new FamilyTree.node(
          e.parent.id + "_split_assitant_level_" + i,
          e.pid,
          [],
          "subLevel"
        );
      ...
      if (d.length) {
        for (
          var m = d[d.length - 1], h = d[0], p = e.children.length - 1;
          p >= 0;
          p--
        ) {
          var f = e.children[p];
          m.children.unshift(f), (f.parent = m), e.children.splice(p, 1);
        }
        e.children.push(h), (h.parent = e);
      }
    }
  }),
  (FamilyTree.manager._verticalAssistantLevelCountIterate = function (e, t, i) {
    ...
    for (var r = 0; r < e.children.length; r++)
      FamilyTree.manager._verticalAssistantLevelCountIterate(
        e.children[r],
        t,
        i
      );
  ...
  (FamilyTree._addDottedLines = function (e) {
    var t = e.nodes;
    if (
      ((e.groupDottedLines.length || e.dottedLines.length) &&
        ...
        if (!i.has(n))
          for (var o = 0; o < t.length; o++)
            if (t[o].id == a.rootId) {
              ((c = JSON.parse(
                JSON.stringify(t[o])
              )).id = `balkan_group_dotted_${a.rootId}_balkan_id_${t[o].id}`),
                (c.pid = void 0),
                (c.stpid = t[o].id),
                t.push(c),
                i.push(n),
                t[o].tags || (t[o].tags = []),
                t[o].tags.push("group-dotted-lines"),
                t[o].tags.push("group-dotted-lines-" + n);
              break;
            }
        ...
        for (o = 0; o < t.length; o++)
          if (t[o].id == d.from) {
            ...
            if (
              (((c = JSON.parse(
                JSON.stringify(t[o])
              )).id = `balkan_dotted_${d.rootId}_balkan_id_${t[o].id}`),
              d.rootId == d.to
                ? (c.pid = d.to)
  ...
  (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, o, l) {
    for (var s = i.nodes, d = [], c = {}, m = {}, h = 0; h < s.length; h++) {
      var p,
        f = s[h];
      ...
      (g.ftChildrenIds = []),
        ...
        null != i.orderBy &&
          (g.order = FamilyTree.manager._getOrderFieldValue(f, i.orderBy)),
        (e[f.id] = g),
        FamilyTree.isNEU(g.stpid)
          ? (FamilyTree.isNEU(g.mid) ||
              (c[g.mid] || (c[g.mid] = []), c[g.mid].push(g.id)),
            FamilyTree.isNEU(g.fid) ||
              (c[g.fid] || (c[g.fid] = []), c[g.fid].push(g.id)),
            FamilyTree.isNEU(g.mid) &&
              FamilyTree.isNEU(g.fid) &&
              FamilyTree.isNEU(g.stpid) &&
    ...
    for (h = 0; h < d.length; h++) {
      ...
      if (T) {
        var b = [];
        FamilyTree.manager._iterateSetRootIds(T.id, T.id, m, c, e, b),
          o.push(b);
      }
    }
    for (h = 0; h < o.length; h++)
      for (var F = 0; F < o.length; F++)
        if (F != h) {
          for (var x = o[h], _ = o[F], w = !1, k = 0; k < x.length; k++)
            if (_.has(x[k])) {
              w = !0;
              break;
            }
          w && ((o[h] = x.concat(_).unique()), (o[F] = []));
        }
  ...
  (FamilyTree.manager._iterateFT = function (e, t, i, r, a, n, o, l, s) {
    ...
    if (
      ...
      var u = a ? a[h.id] : null;
      u && (h.min = u.min), h.stChildrenIds.push(c.id);
    } else
      p || f
    ...
    for (var y = 0; y < c.pids.length; y++) {
      ...
      if (g) {
        ...
        var v = a ? a[g.id] : null;
        if (
          (v && ((g.collapsed = v.collapsed), (g.min = v.min)),
          o == FamilyTree.action.init && (g.min = FamilyTree._getMin(g, s)),
          l && m && v && l.id == c.id
            ? v.hasPartners && 1 == m.isPartner
              ? g.tags.push("left-partner")
              : (v.hasPartners && 2 == m.isPartner) || 1 == m.isPartner
          ...
          for (var T = 0; T < i[g.id].length; T++) {
            var b = r[i[g.id][T]];
            b &&
              (FamilyTree.isNEU(b.fid) || FamilyTree.isNEU(b.mid)) &&
              FamilyTree.manager._iterateFT(i[g.id][T], t, i, r, a, n, o, l, s);
          }
        c.childrenIds.push(g.id);
      }
    }
    if (t[e])
      for (T = 0; T < t[e].length; T++)
  ...
  (FamilyTree.ui = {
    ...
    node: function (e, t, i, r, a, n, o, l, s, d) {
      ...
      for (var p in o) {
        var f,
          u = o[p];
        t && (f = t[u]);
        var y = FamilyTree._lblIsImg(r, p);
        if (
          ((h.value = f),
          (h.element = c[p]),
          (h.name = u),
          ...
          !1 !== FamilyTree.events.publish("field", [d, h]) &&
            ...
            null != h.value &&
            null != h.element &&
            (!y || (y && !FamilyTree.isNEU(h.value))))
        ) {
          if (!y && "string" == typeof h.value) {
            var g = h.element;
            g &&
              (g = g
                .replaceAll("{ew}", e.w - (e.padding ? e.padding[1] : 0))
                .replaceAll("{cw}", e.w / 2)),
              (h.value = FamilyTree.wrapText(h.value, g));
          }
          var v = h.element.replace("{val}", h.value);
          m += v = v
            .replaceAll("{ew}", e.w - (e.padding ? e.padding[1] : 0))
            .replaceAll("{cw}", e.w / 2)
        ...
        if (t.childrenIds.length > 0) {
          if (t.hasPartners) {
            for (var c = !1, m = 0; m < t.childrenIds.length; m++) {
              var h = e.getNode(t.childrenIds[m]);
              !h || h.parentPartner || h.isPartner || (c = !0);
            }
            if (!c) return "";
          }
          ...
          if (
            ...
            var p = FamilyTree.collapsedChildrenCount(e, t);
    ...
    link: function (e, t, i, r, a, n, o) {
      var l = e.lcn ? e.lcn : "base",
        ...
        c = [],
        m = [],
        h = s.levelSeparation / 2;
      e.layout > 0 && (h = s.mixedHierarchyNodesSeparation / 2);
      var p = 0,
      ...
      if (e.hasPartners) {
        ...
        for (var g = 0; g < e.children.length; g++) {
          (T = e.children[g]).parentPartner
            ? ((y.ppnodes[T.id] = T.parentPartner),
              y.ids.push(T.id),
              1 == T.parentPartner.isPartner
                ? (-1 == y.rightIds.indexOf(T.parentPartner.id) &&
                    y.rightIds.push(T.parentPartner.id),
                  (y.indexes[T.id] = y.rightIds.indexOf(T.parentPartner.id)),
                  y.firstRight || (y.firstRight = T))
                : 2 == T.parentPartner.isPartner &&
                  (-1 == y.leftIds.indexOf(T.parentPartner.id) &&
                    y.leftIds.push(T.parentPartner.id),
                  (y.indexes[T.id] = y.leftIds.indexOf(T.parentPartner.id)),
                  (y.lastLeft = T)))
            : T.isPartner ||
              ((y.lastLeft = T), y.firstRight || (y.firstRight = T));
        }
        (y.maxSidePartnersWithChildren = Math.max(
          y.leftIds.length,
          y.rightIds.length
        )),
          (p =
            0 == y.maxSidePartnersWithChildren
              ? t.config.minPartnerSeparation / 2
              : t.config.minPartnerSeparation / 2 +
                y.partnerChildrenSplitSeparation *
                  y.maxSidePartnersWithChildren +
                y.partnerChildrenSplitSeparation / 2);
      }
      for (g = 0; g < e.children.length; g++) {
        ...
        if (T.isChildOfPartner)
          switch (s.orientation) {
            case FamilyTree.orientation.top:
            case FamilyTree.orientation.top_left:
              var _ = 1 == T.layout ? void 0 : b.minY - (b.minY - u.maxY) / 2;
              F = FamilyTree.ui._linkTopToBottom(T.parentPartner, T, d, h, _);
              break;
            case FamilyTree.orientation.bottom:
            case FamilyTree.orientation.bottom_left:
              _ = 1 == T.layout ? void 0 : b.maxY - (b.maxY - u.minY) / 2;
              F = FamilyTree.ui._linkBottomToTop(T.parentPartner, T, d, h, _);
              break;
            case FamilyTree.orientation.right:
            case FamilyTree.orientation.right_top:
              _ = 1 == T.layout ? void 0 : b.maxX - (b.maxX - u.minX) / 2;
              F = FamilyTree.ui._linkRightToLeft(T.parentPartner, T, d, h, _);
              break;
            case FamilyTree.orientation.left:
            case FamilyTree.orientation.left_top:
              _ = 1 == T.layout ? void 0 : b.minX - (b.minX - u.maxX) / 2;
              F = FamilyTree.ui._linkLeftToRight(T.parentPartner, T, d, h, _);
          }
        else if (y && -1 != y.ids.indexOf(T.id))
          switch (s.orientation) {
            case FamilyTree.orientation.top:
            case FamilyTree.orientation.top_left:
          ...
          var w =
              ...
              T.parent == T.rightNeighbor.parent,
            k =
              T.isAssistant &&
              T.leftNeighbor &&
              T.leftNeighbor.isAssistant &&
              T.parent == T.leftNeighbor.parent;
          if ((w || T.layout > 1) && T.rightNeighbor && T.rightNeighbor.isSplit)
            switch (s.orientation) {
              case FamilyTree.orientation.top:
              case FamilyTree.orientation.top_left:
              case FamilyTree.orientation.bottom:
              case FamilyTree.orientation.bottom_left:
                F = FamilyTree.ui._linkRightToLeft(T.rightNeighbor, T, d, h);
                break;
              case FamilyTree.orientation.right:
              case FamilyTree.orientation.right_top:
              case FamilyTree.orientation.left:
              case FamilyTree.orientation.left_top:
                F = FamilyTree.ui._linkBottomToTop(T.rightNeighbor, T, d, h);
            }
          else if (
            (k || T.layout > 1) &&
            T.leftNeighbor &&
            T.leftNeighbor.isSplit
          )
            switch (s.orientation) {
              case FamilyTree.orientation.top:
              case FamilyTree.orientation.top_left:
              case FamilyTree.orientation.bottom:
              case FamilyTree.orientation.bottom_left:
                F = FamilyTree.ui._linkLeftToRight(T.leftNeighbor, T, d, h);
                break;
              case FamilyTree.orientation.right:
              case FamilyTree.orientation.right_top:
              case FamilyTree.orientation.left:
              case FamilyTree.orientation.left_top:
                F = FamilyTree.ui._linkTopToBottom(T.leftNeighbor, T, d, h);
            }
          else
            switch (s.orientation) {
              case FamilyTree.orientation.top:
              case FamilyTree.orientation.top_left:
                if (1 == T.isPartner)
                  F = FamilyTree.ui._linkLeftToRight(e, T, d, p);
                else if (2 == T.isPartner)
                  F = FamilyTree.ui._linkRightToLeft(e, T, d, p);
                else {
                  _ = 1 == T.layout ? void 0 : b.minY - (b.minY - u.maxY) / 2;
                  F = FamilyTree.ui._linkTopToBottom(e, T, d, h, _);
                }
                break;
              case FamilyTree.orientation.bottom:
              case FamilyTree.orientation.bottom_left:
                if (1 == T.isPartner)
                  ...
                  _ = 1 == T.layout ? void 0 : b.maxY - (b.maxY - u.minY) / 2;
                  F = FamilyTree.ui._linkBottomToTop(e, T, d, h, _);
                }
                break;
              case FamilyTree.orientation.right:
              case FamilyTree.orientation.right_top:
                if (1 == T.isPartner)
                  F = FamilyTree.ui._linkTopToBottom(e, T, d, p);
                else if (2 == T.isPartner)
                  F = FamilyTree.ui._linkBottomToTop(e, T, d, p);
                else {
                  _ = 1 == T.layout ? void 0 : b.maxX - (b.maxX - u.minX) / 2;
                  F = FamilyTree.ui._linkRightToLeft(e, T, d, h, _);
                }
                break;
              case FamilyTree.orientation.left:
              case FamilyTree.orientation.left_top:
                if (1 == T.isPartner)
                  ...
                  _ = 1 == T.layout ? void 0 : b.minX - (b.minX - u.maxX) / 2;
                  F = FamilyTree.ui._linkLeftToRight(e, T, d, h, _);
                }
            }
        }
        var S = FamilyTree.ui._draggableLinkPath(t, e, T, F, h, s.orientation);
        if (S)
          (v = S),
            (x = x
          ...
          if (
            (F.xa == F.xb && F.xa == F.xc && F.xa == F.xd) ||
            (F.ya == F.yb && F.ya == F.yc && F.ya == F.yd)
          )
            (v = "M" + F.xa + "," + F.ya + " L" + F.xd + "," + F.yd),
              (x = x.replaceAll("{rounded}", v));
          else if (
            Math.abs(F.xa - F.xd) <= FamilyTree.LINK_ROUNDED_CORNERS &&
            Math.abs(F.xa - F.xc) <= FamilyTree.LINK_ROUNDED_CORNERS &&
            Math.abs(F.xa - F.xb) <= FamilyTree.LINK_ROUNDED_CORNERS
          )
            (v = "M" + F.xa + "," + F.ya + " L" + F.xa + "," + F.yd),
              (x = x.replaceAll("{rounded}", v));
          else if (
            Math.abs(F.ya - F.yd) <= FamilyTree.LINK_ROUNDED_CORNERS &&
            Math.abs(F.ya - F.yc) <= FamilyTree.LINK_ROUNDED_CORNERS &&
            Math.abs(F.ya - F.yb) <= FamilyTree.LINK_ROUNDED_CORNERS
          )
            (v = "M" + F.xa + "," + F.ya + " L" + F.xd + "," + F.ya),
              (x = x.replaceAll("{rounded}", v));
          else {
            var C = FamilyTree.ui._roundedEdge(
                F.xa,
                F.ya,
                F.xb,
                F.yb,
        ...
        c.push(
          FamilyTree.linkOpenTag
            .replaceAll("{id}", e.id)
            .replaceAll("{class}", "link " + T.tags.join(" "))
            .replaceAll("{child-id}", T.id)
        );
        var N = { node: e, cnode: T, p: F, html: x, action: n };
        FamilyTree.events.publish("render-link", [t, N]),
          c.push(N.html),
          o && m.push({ id: e.id, childId: T.id, html: N.html });
        var A = "";
        for (var L in t.config.linkBinding) {
          ...
          if (M) {
            ...
            (N.value = O),
              (N.element = d[L]),
              (N.name = E),
              !1 !== FamilyTree.events.publish("label", [t, N]) &&
                (FamilyTree.isNEU(N.value) ||
                  FamilyTree.isNEU(N.element) ||
                  (A += N.element.replace("{val}", N.value)));
          }
        }
        if ("" != A) {
          var U = F.x,
            B = F.y;
          null != T.movey && (B += T.movey),
            (A =
              FamilyTree.linkFieldsOpenTag
                .replace("{x}", U)
                .replace("{y}", B)
        ...
        (d = t.y + i.linkAdjuster.fromY),
        {
          ...
          yb: (c =
            ...
            "split" == t.templateName
              ...
              : "split" == e.templateName && (t.isAssistant || t.layout > 1)
              ? d
              : "split" == t.templateName
              ? o + r
              : null != a
    ...
    _linkPpTop: function (e, t, i, r, a, n) {
      ...
      return (
        (s = c.mid),
        FamilyTree.ui._linkTopToBottom({ x: m, y: l, w: 0, h: 0 }, i, n, 0, s)
      );
    },
    _linkPpBottom: function (e, t, i, r, a, n) {
      ...
      return (
        (s = c.mid),
        FamilyTree.ui._linkBottomToTop({ x: m, y: l, w: 0, h: 0 }, i, n, 0, s)
      );
    },
    _linkPpLeft: function (e, t, i, r, a, n) {
      ...
      return (
        (l = c.mid),
        FamilyTree.ui._linkLeftToRight({ x: d, y: m, w: 0, h: 0 }, i, n, 0, l)
      );
    },
    _linkPpRight: function (e, t, i, r, a, n) {
      ...
      return (
        (l = c.mid),
        FamilyTree.ui._linkRightToLeft({ x: d, y: m, w: 0, h: 0 }, i, n, 0, l)
      );
    },
      ...
      if (FamilyTree._isMoved(i) && !FamilyTree._isMoved(t)) {
        ...
        switch (n) {
          ...
          case FamilyTree.orientation.top_left:
            ...
            (s = r.xa < r.xd ? i.x - a / 2 : i.x + i.w + a / 2),
              (d = i.y - a / 2);
            break;
          case FamilyTree.orientation.bottom:
          case FamilyTree.orientation.bottom_left:
          ...
          case FamilyTree.orientation.right_top:
            ...
            (d = r.ya < r.yd ? i.y - a / 2 : i.y + i.h + a / 2),
              (s = i.x + i.w + a / 2);
            break;
          case FamilyTree.orientation.left:
          case FamilyTree.orientation.left_top:
        ...
        return FamilyTree.roundPathCorners(
          o,
          FamilyTree.LINK_ROUNDED_CORNERS,
          !1
        );
      }
      if (!FamilyTree._isMoved(i) && FamilyTree._isMoved(t)) {
        ...
        switch (n) {
          ...
          case FamilyTree.orientation.top_left:
            if (r.ya + a / 2 > r.yb)
              (l = !0),
                (s = r.xa < r.xd ? t.x + t.w + a / 2 : t.x - a / 2),
                (d = t.y + t.h + a);
            else {
              if (r.yb + a / 2 < r.yd) return null;
              (s = r.xa < r.xd ? i.x - a / 2 : i.x + i.w + a / 2),
          ...
          case FamilyTree.orientation.right_top:
            if (r.xa - a / 2 < r.xb)
              (l = !0),
                (d = r.ya < r.yd ? t.y + t.h + a / 2 : t.y - a / 2),
                (s = t.x - a);
            else {
              if (r.xb - a / 2 > r.xd) return null;
              (d = r.ya < r.yd ? i.y - a / 2 : i.y + i.h + a / 2),
        ...
        switch (n) {
          ...
          case FamilyTree.orientation.top_left:
            if (r.ya + a > r.yd) {
              ...
              o.push(["M", r.xa, r.ya]),
                o.push(["L", r.xa, t.y + t.h + a]),
                o.push(["L", r.xc, t.y + t.h + a]),
                o.push(["L", r.xd, r.yd]);
            break;
          case FamilyTree.orientation.bottom:
          case FamilyTree.orientation.bottom_left:
          ...
          case FamilyTree.orientation.left_top:
            if (r.xa + a > r.xd) {
              ...
              o.push(["M", r.xa, r.ya]),
                o.push(["L", t.x + t.w + a, r.ya]),
                o.push(["L", t.x + t.w + a, r.yc]),
                o.push(["L", r.xd, r.yd]);
        }
        return FamilyTree.roundPathCorners(
          o,
    ...
    if (
      ...
      !(function (e, r, a) {
        ...
        function o() {
          ...
          Math.ceil(t.bar.scrollLeft) == Math.ceil(t.position)
            ? (n = !1)
            : ((t.bar.scrollLeft += e), l(o));
        }
        e.addEventListener(
          "wheel",
          function (e) {
            ...
            if (t.config.mouseScrool == FamilyTree.action.xScroll)
              (a = e.deltaX || e.wheelDeltaX) ||
                (a = e.deltaY || e.wheelDeltaY);
            else if (
  ...
  (FamilyTree.xScrollUI.prototype.setPosition = function () {
    if (this.bar) {
      ...
      (this.bar.ignore = !0),
        ...
        FamilyTree.events.publish("change", [
          this,
    ...
    if (
      ...
      !(function (e, r, a) {
        ...
        function o() {
          ...
          Math.ceil(t.bar.scrollTop) == Math.ceil(t.position)
            ? (n = !1)
            : ((t.bar.scrollTop += e), l(o));
        }
        e.addEventListener(
          "wheel",
          function (e) {
  ...
  (FamilyTree.yScrollUI.prototype.setPosition = function () {
    if (this.bar) {
      var e = this.requestParams(),
        t =
          (Math.abs(e.boundary.maxY - e.boundary.minY) +
            2 * this.config.padding) *
          e.scale;
      switch (this.config.orientation) {
        case FamilyTree.orientation.bottom:
  ...
  (FamilyTree.pdfPrevUI._handler = function (e, t, i) {
    ...
    for (
      ...
      var u = h.getElementById("bft-header"),
        y = h.getElementById("bft-footer");
      if (u) {
  ...
  FamilyTree.events.on("drag", function (e, t, i, r) {
    if (e instanceof FamilyTree && e.config.movable && r)
      for (var a = 0; a < r.length; a++) {
        for (
          var n = r[a],
            o = e.element.querySelectorAll(`[data-c-l-from="${n}"]`),
            l = e.element.querySelectorAll(`[data-c-l-to="${n}"]`),
            s = 0;
          s < o.length;
          s++
        )
  ...
  (FamilyTree.prototype._clink = function (e, t) {
    for (var i = "", r = 0; r < this.config.clinks.length; r++) {
      ...
      if (
        n &&
        -1 != t.res.visibleNodeIds.indexOf(n.id) &&
        o &&
        -1 != t.res.visibleNodeIds.indexOf(o.id)
      ) {
        var l = n.x,
          s = n.y,
          d = o.x,
        ...
        if (a.label) {
          var F = FamilyTree.clinkLabelPosition(a, m, h, v);
          i += b.label
            .replace("{x}", F.x)
            .replace("{y}", F.y)
            .replace("{val}", a.label);
      ...
      function _(e, t, i) {
        ...
        return (
          (o = (o / (Math.sqrt(r * r + n * n) * i)) * FamilyTree.clinkCurve(a)),
          { x: e.x + r / 2 - n * o, y: e.y + n / 2 + r * o }
        );
      }
    }
    t.content += i;
  ...
  (FamilyTree.prototype.addClink = function (e, t, i, r) {
    ...
    return (
      this.config.clinks.push({ from: e, to: t, label: i, template: r }),
      FamilyTree.events.publish("updated", [this]),
      this
    );
  }),
  ...
  FamilyTree.events.on("drag", function (e, t, i, r) {
    if (e instanceof FamilyTree && e.config.movable && r)
      for (var a = 0; a < r.length; a++) {
        for (
          var n = r[a],
            o = e.element.querySelectorAll(`[data-s-l-from="${n}"]`),
            l = e.element.querySelectorAll(`[data-s-l-to="${n}"]`),
            s = 0;
          s < o.length;
          s++
        )
  ...
  (FamilyTree.prototype._slinks = function (e, t) {
    ...
    function n(t, n, o) {
      ...
      var p = FamilyTree.t(t.templateName, t.min, r),
        f = h.levelSeparation;
      t.parent && t.parent.layout && (f = h.mixedHierarchyNodesSeparation);
      var u = {
      ...
      if (t.sl == n.sl)
        switch (((d = n), h.orientation)) {
          ...
          case FamilyTree.orientation.left_top:
            (u.p = t.x),
              (u.q = t.y + t.h / 2 + p.expandCollapseSize),
              (u.r = a.minX - f),
              (u.s = t.y + t.h / 2 + p.expandCollapseSize),
              s.push([u.p, u.q]),
              s.push([t.x - f / 3, u.q]),
              (p = FamilyTree.t(d.templateName, d.min, r)),
              s.push([
        ...
        for (; null == d; ) {
          ...
          if (
            (T.id == n.id
              ? (d = T)
              : FamilyTree._intersects(T, u, h) &&
                ((u = FamilyTree._addPoint(T, s, h, u, c)), (v = !0)),
            T.id != n.id)
          ) {
            for (; b; ) {
              if (b.id == n.id) {
              ...
              FamilyTree._intersects(b, u, h) &&
                ((u = FamilyTree._addPoint(b, s, h, u, c)), (v = !0)),
                (b = b.leftNeighbor);
            }
            for (; F; ) {
              if (F.id == n.id) {
              ...
              FamilyTree._intersects(F, u, h) &&
                ((u = FamilyTree._addPoint(F, s, h, u, c)), (v = !0)),
                (F = F.rightNeighbor);
            }
          }
          if (!v) {
            ...
            if (T.parent) {
              (f = h.levelSeparation),
                T.parent.layout && (f = h.mixedHierarchyNodesSeparation);
      ...
      var S,
        C,
        I = null;
      switch ((p = FamilyTree.slinkTemplates[k]).labelPosition) {
        case "start":
          I = { x: s[1][0], y: s[1][1] };
          break;
        case "middle":
      ...
      var L = FamilyTree.roundPathCorners(
        s,
        FamilyTree.LINK_ROUNDED_CORNERS,
        !1
      );
  ...
  (FamilyTree.prototype.addSlink = function (e, t, i, r) {
    ...
    return (
      this.config.slinks.push({ from: e, to: t, label: i, template: r }),
      FamilyTree.events.publish("updated", [this]),
      this
    );
  }),
    ...
    if (t.node && t.node.tags && t.node.tags.has("group-dotted-lines")) {
      ...
      t.node.min
        ? (r.nodeGroupDottedOpenButton ||
            console.error(
              `[${t.node.templateName}].nodeGroupDottedOpenButton is not defined`
            ),
        ...
        : (r.nodeGroupDottedCloseButton ||
            console.error(
              `[${t.node.templateName}].nodeGroupDottedCloseButton is not defined`
            ),
        ...
        (a = (a += "</g>")
          ...
          .replaceAll(
            "{ew}",
            t.node.w - (t.node.padding ? t.node.padding[1] : 0)
          )
          .replaceAll(
            "{eh}",
            t.node.h - (t.node.padding ? t.node.padding[2] : 0)
          ));
  ...
  void 0 === FamilyTree && (FamilyTree = {}),
  (FamilyTree.prototype.undo = function (e) {
    if (this.config.undoRedoStorageName) {
      ...
      if (0 != t) {
        ...
        (this.config.nodes = a.nodes),
          ...
          FamilyTree.events.publish("updated", [this]),
          this.filterUI.update(),
          this.draw(FamilyTree.action.update, void 0, e),
  ...
  (FamilyTree.prototype.clearRedo = function () {
    if (this.config.undoRedoStorageName) {
      for (
        var e = `${this.config.undoRedoStorageName}_redo_`,
          t = Object.keys(sessionStorage),
          i = 0;
        -1 != t.indexOf(e + i);

      )
        sessionStorage.removeItem(e + i), i++;
      this.undoRedoUI.refresh();
    }
  }),
  (FamilyTree.prototype.clearUndo = function () {
    if (this.config.undoRedoStorageName) {
      for (
        var e = `${this.config.undoRedoStorageName}_undo_`,
          t = Object.keys(sessionStorage),
          i = 0;
        -1 != t.indexOf(e + i);
  ...
  void 0 === FamilyTree && (FamilyTree = {}),
  (FamilyTree.undoRedoUI = function () {
  ...
  (FamilyTree.undoRedoUI.prototype.refresh = function () {
    ...
    if (this.instance.config.undoRedoStorageName) {
      ...
      if (!1 !== FamilyTree.events.publish("change", [this, t])) {
        ...
        if (!i || !r) {
          var a = document.createElement("div");
          a.classList.add("bft-undo-redo"),
            (a.innerHTML = `<span data-undo>${FamilyTree.icon.undo(
              50,
              50,
              ""
            )}<span class="bft-undo-i"></span></span>\n                            <span data-redo>${FamilyTree.icon.redo(
              50,
              50,
              ""
            )}<span class="bft-redo-i"></span></span>`),
            this.instance.element.appendChild(a),
            (i = this.instance.element.querySelector("[data-undo]")),
            (r = this.instance.element.querySelector("[data-redo]")),
            i.addEventListener("click", function () {
              e.instance.undo();
            }),
        ...
        t.undoStepsCount > 0
          ? (i.classList.add("bft-ur-clickable"),
            (i.querySelector(".bft-undo-i").innerHTML = t.undoStepsCount),
            (i.querySelector(".bft-undo-i").style.display = "inline-block"))
          : (i.classList.remove("bft-ur-clickable"),
            (i.querySelector(".bft-undo-i").style.display = "none")),
          t.redoStepsCount > 0
            ? (r.classList.add("bft-ur-clickable"),
              (r.querySelector(".bft-redo-i").innerHTML = t.redoStepsCount),
              (r.querySelector(".bft-redo-i").style.display = "inline-block"))
            : (r.classList.remove("bft-ur-clickable"),
              (r.querySelector(".bft-redo-i").style.display = "none"));
      }
    }
  }),
      ...
      if (e.manager.action != FamilyTree.action.move) {
        ...
        (l.onmousedown = function (e) {
          ...
          if (
            ...
            (t = a),
            (n =
              (r - FamilyTree.miniMap._settings._translateX) /
              FamilyTree.miniMap._settings._scale),
            (o =
              (t - FamilyTree.miniMap._settings._translateY) /
              FamilyTree.miniMap._settings._scale),
            n > i[0] && n < i[0] + i[2] && o > i[1] && o < i[1] + i[3])
          )
          ...
          (l.onmousemove = function (t) {
            if (s) {
              ...
              var c = l.getBoundingClientRect(),
                m = c.left,
                h = c.top;
              (n = parseInt(t.clientX - m)), (o = parseInt(t.clientY - h));
              var p = (n - r) / FamilyTree.miniMap._settings._scale,
  ...
  (FamilyTree.miniMap._drawMainCanvas = function (e) {
    ...
    var r = 0,
      a = [];
    !(function e(t, n) {
      if (Array.isArray(n)) for (var o = 0; o < n.length; o++) e(t, n[o]);
      else {
        ...
        for (o = 0; o < n.stChildrenIds.length; o++)
          r++,
            a.includes(n.id) ||
              ...
              i.strokeRect(n.x, n.y, n.w, n.h),
              a.push(n.id)),
            e(t, t.getNode(n.stChildrenIds[o])),
            r--;
        for (o = 0; o < n.childrenIds.length; o++)
          e(t, t.getNode(n.childrenIds[o]));
      }
    })(e, e.roots);
  }),
  ...
  (FamilyTree.miniMap._init = function (e) {
    if (!e.element.querySelector('[data-id="mini-map"]')) {
      ...
      for (
        ...
        var o = a[n];
        FamilyTree.isNEU(FamilyTree.miniMap.position[o]) ||
          ("padding" == FamilyTree.miniMap.position[o]
            ? (r.style[o] = e.config.padding + "px")
            : (r.style[o] = FamilyTree.miniMap.position[o] + "px"));
      }
      ...
      (l.style.position = "relative"),
        (l.style.width = FamilyTree.miniMap.width + "px"),
        (l.style.height = FamilyTree.miniMap.height + "px"),
        l.appendChild(t),
        l.appendChild(i),
        r.appendChild(l),
        e.element.appendChild(r);
  ...
  (FamilyTree._search = {}),
  (FamilyTree._search.search = function (e, t, i, r, a, n, o) {
    var l = [],
      s = t.toLowerCase(),
      d = s.split(" ");
    if (o && d.length > 1) {
    ...
    for (var m = {}, h = 0; h < e.length; h++)
      for (var p = e[h], f = 0; f < i.length; f++) {
        var u = i[f];
        if (!FamilyTree.isNEU(p[u])) {
          var y = p[u];
          if (
            null != (t = FamilyTree._search.searchAndComputeScore(d, y, u, n))
          ) {
            var g = p.id;
            if (m[g]) {
              if (m[g] && m[g] < t.__score) {
                ...
                for (var v = l.length - 1; v >= 0; v--)
                  l[v].id == g && l.splice(v, 1);
                FamilyTree._search.addNodeToResult(l, r, p, t, u, a);
              }
            } else
              (m[g] = t.__score),
                FamilyTree._search.addNodeToResult(l, r, p, t, u, a);
  ...
  (FamilyTree._search.searchAndComputeScore = function (e, t, i, r) {
    ...
    for (
      var o = a.length / 100, l = 0, s = 0, d = l > 0 ? 100 : 0, c = 0, m = 0;
      m < e.length;
      m++
    )
      for (var h = e[m], p = 0; p < n.length; p++)
        if (-1 != h.indexOf(n[p].searchPhrase)) {
          c++;
          break;
        }
      ...
      for (var r = 0; r < t.length; r++) {
        ...
        if (!FamilyTree.isNEU(a))
          for (var n = 0; (n = e.indexOf(a, n)) > -1; )
            i.push({ length: a.length, start: n, searchPhrase: a }),
              (n += a.length);
      }
    return (
      i.sort(function (e, t) {
  ...
  (FamilyTree.state._put = function (e, t, i, r, a, n, o, l) {
    if (l && !FamilyTree.isNEU(a) && 0 != a.length) {
      ...
      if (l.writeToUrlParams) {
        ...
        c.has(s.paramScale)
          ? c.set(s.paramScale, d.scale)
          : c.append(s.paramScale, d.scale),
          c.has(s.paramX) ? c.set(s.paramX, d.x) : c.append(s.paramX, d.x),
          c.has(s.paramY) ? c.set(s.paramY, d.y) : c.append(s.paramY, d.y),
          c.has(s.paramExp)
            ? c.set(s.paramExp, d.exp.join("*"))
            : c.append(s.paramExp, d.exp.join("*")),
          c.has(s.paramRoots) && Array.isArray(d.roots)
            ? c.set(s.paramRoots, d.roots.join("*"))
            : Array.isArray(d.roots) &&
              c.append(s.paramRoots, d.roots.join("*")),
          c.has(s.paramMin)
            ? c.set(s.paramMin, d.min.join("*"))
            : c.append(s.paramMin, d.min.join("*")),
      ...
      l.writeToIndexedDB &&
        ...
        l.writeToLocalStorage &&
          FamilyTree.localStorage.setItem(l.name, JSON.stringify(d));
    }
  }),
    ...
    if (e) {
      ...
      if (e.readFromUrlParams) {
        ...
        if (
          ...
          return (
            (o.adjustify = { x: parseFloat(c[0]), y: parseFloat(c[1]) }),
            void r(o)
          );
        }
  ...
  FamilyTree.events.on("init", function (e, t) {
    if (
      ...
      var i = e.roots[0].id;
      FamilyTree.isNEU(e.config.keyNavigation.focusId) ||
        (i = e.config.keyNavigation.focusId),
    ...
    return (
        ...
        (n = `<a href="#" data-input-btn="" class="bft-link bft-link-bft-button">${t.btn}</a>`),
      {
        html: `<div class="bft-form-field" style="min-width: ${i};">\n                    <div class="bft-input" data-bft-input="" ${
          ...
          a.id
        }">${FamilyTree._escapeGreaterLessSign(
          a.label
        )}</label>\n                        <input ${
          a.readOnlyAttribute
        } data-binding="${FamilyTree._escapeDoubleQuotes(
          a.binding
  ...
  (FamilyTree.elements.checkbox = function (e, t, i, r) {
    ...
    return {
      html: `<div class="bft-form-field"  style="min-width: ${i};" >\n                        <label class="bft-checkbox" data-bft-input="" ${
        a.disabledAttribute
      }>\n                            <input ${n} ${o} data-binding="${FamilyTree._escapeDoubleQuotes(
        a.binding
      ...
      : {
          html: `<div class="bft-form-field" style="min-width: ${i};">\n                    <div class="bft-input" data-bft-input="" ${
            ...
            for (var e = "", t = 0; t < a.options.length; t++) {
              ...
              } value="${FamilyTree._escapeDoubleQuotes(
                i.value
  ...
  (FamilyTree.elements.multiSelect = function (e, t, i, r) {
    if (r) return FamilyTree.elements.textbox(e, t, i, r);
    var a = FamilyTree.elements._vidrf(e, t, r);
    return a.doNotRender
      ? { html: "" }
      : {
          html: `<div class="bft-form-field" style="min-width: ${i};">\n                    <div class="bft-input" data-bft-input="" ${
            ...
            a.label
          )}</label>\n                        <select class="multiple" data-binding="${FamilyTree._escapeDoubleQuotes(
            a.binding
          )}" ${a.readOnlyAttribute} id="${a.id}" name="${
            a.id
          }" multiple>\n                            ${(function () {
            for (var e = "", t = 0; t < a.options.length; t++) {
              var i = a.options[t];
              e += `<option ${
                a.value.includes(i.value) ? "selected" : ""
              } value="${FamilyTree._escapeDoubleQuotes(
                i.value
              )}">${FamilyTree._escapeGreaterLessSign(i.text)}</option>`;
            }
  ...
  (FamilyTree.input.blurHandler = function (e) {
    ...
    t.classList.remove("focused"),
      e.value || "date" == e.type
        ? t.classList.add("hasval")
        : t.classList.remove("hasval");
  }),
  (FamilyTree.input.validate = function (e) {
    ...
    !t.selectedOptions && t.value && (t.value = t.value.trim());
  ...
  (FamilyTree.input.validateAndGetData = function (e) {
    ...
    for (r = 0; r < n.length; r++) {
      ...
      else if (l.selectedOptions) {
        var d = l.selectedOptions;
        o[s] = Array.from(d).map(({ value: e }) => e);
      } else o[s] = l.value;
    }
    return o;
  }),
  ...
  (FamilyTree.prototype.showTreeMenu = function (e) {
    ...
    if (n) m.push(n);
      ...
      (c.mid = h.id),
        a
          ? ((a.pids = [h.id]), (h.pids = [a.id]), (h._ft_data.pids = [a.id]))
          : (h.pids = ["_ft_father"]),
        m.push(h);
    }
    if (a) m.push(a);
      ...
      (c.fid = p.id),
        n
          ? ((n.pids = [p.id]), (p.pids = [n.id]), (p._ft_data.pids = [n.id]))
          : (p.pids = ["_ft_mother"]),
        m.push(p);
    }
      ...
      for (s = 0; s < c.pids.length; s++) {
        ...
        for (var g = 0; g < l.length; g++)
          (l[g].mid != c.pids[s] && l[g].fid != c.pids[s]) ||
            ((l[g].mid = void 0),
            (l[g].fid = void 0),
            (l[g].stpid = "_ft_child_group_" + s),
            m.push(l[g]));
      }
    var v = [];
    for (g = 0; g < l.length; g++)
      ((l[g].fid == c.id && FamilyTree.isNEU(l[g].mid)) ||
        (l[g].mid == c.id && FamilyTree.isNEU(l[g].fid))) &&
        (l[g].fid == c.id
          ? (l[g].mid = "_ft_partner_for_single_child")
          : l[g].mid == c.id && (l[g].fid = "_ft_partner_for_single_child"),
        m.push(l[g]),
        v.push(l[g].id));
    if (v.length) {
      var T = {
    ...
    FamilyTree.events.publish("node-tree-menu-show", [this, b]),
      b.nodes.push(b.node),
      (this.config.nodes = b.nodes),
      (c = this.get(e));
    var F = this;
  ...
  (FamilyTree.filterUI.prototype.update = function () {
    if (this.instance.config.filterBy) {
      ...
      if ("all" == this.instance.config.filterBy)
        for (
          var t = FamilyTree.manager.getAllFields(this.instance.config), i = 0;
          i < t.length;
          i++
        ) {
          var r = t[i];
        ...
        for (i = 0; i < this.instance.config.filterBy.length; i++)
          e[this.instance.config.filterBy[i]] = {};
      else if ("object" == typeof this.instance.config.filterBy)
        for (var a in this.instance.config.filterBy) e[a] = {};
      for (var n in e) {
        var o = e[n];
      ...
      (this.element = this.instance.element.querySelector("[data-filter]")),
        ...
        this.element.setAttribute("class", "bft-filter"),
      ...
      (this.element.innerHTML = `<div>${m}</div>`),
        this.element.addEventListener("click", function (e) {
          if (
            ...
            e.target.hasAttribute("data-filter-field")
          ) {
            for (
            ...
            if (!o) {
              ...
              var f = o.querySelectorAll("input");
              for (r = 0; r < f.length; r++)
                f[r].addEventListener("change", function (e) {
                  for (
                    var t = e.target;
                    t && !t.hasAttribute("data-filter-menu");
        ...
        FamilyTree.events.publish("update", [this, {}]);
    }
  }),
  ...
  (FamilyTree.remote._setPositions = function (e, t, i, r) {
    for (
      var a = [],
        n = [],
        o = FamilyTree.remote._toReqLayoutConfigsDTO(t),
        l = 0;
      l < e.length;
      l++
    )
      n.push(e[l].id), FamilyTree.remote._toReqDTO(e[l], a);
    var s = { n: a, c: o, r: n, v: "8.14.00" };
    if (
      (FamilyTree.LIMIT_NODES || (s.l = !0),
      null != FamilyTree.remote._fromReqDTO)
    )
      FamilyTree.remote._fromReqDTO(s.n, s.r, s.c, function (t) {
        for (var a = 0; a < e.length; a++)
          FamilyTree.remote._fromResDTO(e[a], t, 0, e, r);
        i();
      });
    else {
      s = JSON.stringify(s);
  ...
  (FamilyTree.remote._proceed = function (e, t, i, r) {
    if (("string" == typeof t && (t = JSON.parse(t)), t.limit && 1 == t.limit))
      r(t.limit);
    else {
      for (var a = 0; a < e.length; a++)
        FamilyTree.remote._fromResDTO(e[a], t, 0, e, i);
      r();
    }
  }),
